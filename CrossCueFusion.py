...
class CrossCueFusion(nn.Module):
    def __init__(self, cv_hypo_num=32, mid_dim=32, input_size=(256, 512)):
        ...
        self.conv_layer = nn.Conv2d(in_channels=64, out_channels=32, kernel_size=1)
...
if __name__ == '__main__':
    data1 = torch.rand(1, 32, 260, 346).cuda()
    data2 = torch.rand(1, 32, 260, 346).cuda()
    model = CrossCueFusion().cuda()
    print(model(data1, data2).shape)
